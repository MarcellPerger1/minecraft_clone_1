...
// TODO: thisArg = 
function loadTextureWithCallback(gl, url, callback=null){
  const texture = gl.createTexture();
  gl.bindTexture(gl.TEXTURE_2D, texture);
...
function loadTextureWithInfo(gl, url, callback=null, thisArg=null){
